/*
 * arch/sh/boards/st/mb628e/setup.c
 *
...
static void __init mb628e_setup(char **cmdline_p)
{
	u8 test;
	...
	printk(KERN_INFO "mb628e EPLD version %ld, test %s\n",
...
static struct plat_stmnand_data mb628e_nand_config = {
	.emi_bank		= 0,
...
static int mb628e_phy_reset(void *bus)
{
	u8 reg;
	static int first = 1;
...
static struct platform_device mb628e_snd_spdif_input = {
	.name = "snd_conv_dummy",
	.id = -1,
...
static struct platform_device mb628e_snd_external_dacs = {
	.name = "snd_conv_epld",
	.id = -1,
...
static struct platform_device *mb628e_devices[] __initdata = {
	&epld_device,
	&physmap_flash,
	&phy_devices[0],
	&phy_devices[1],
#ifdef CONFIG_SND
	&mb628e_snd_spdif_input,
	&mb628e_snd_external_dacs,
#endif
};
...
static int __init device_init(void)
{
...
#ifndef FLASH_NOR
	stx7141_configure_nand(&mb628e_nand_config);
	...
	return platform_add_devices(mb628e_devices, ARRAY_SIZE(mb628e_devices));
}
arch_initcall(device_init);

static void __iomem *mb628e_ioport_map(unsigned long port, unsigned int size)
{
	/*
...
static void __init mb628e_init_irq(void)
{
}

struct sh_machine_vector mv_mb628e __initmv = {
	.mv_name		= "mb628e",
	.mv_setup		= mb628e_setup,
	.mv_nr_irqs		= NR_IRQS,
	.mv_init_irq		= mb628e_init_irq,
	.mv_ioport_map		= mb628e_ioport_map,
};
