...
void __init hmp_setup(char** cmdline_p)
{
...
static struct plat_ssc_data ssc_private_info = {
	.capability  =
    /* ssc1 is for I2C1 bus,now DUAL 297E ok! 
       see bugzilla#4969 and #4334 */
...
static int hmp_phy_reset(void* bus)
{
...
static struct plat_stmmacphy_data phy_private_data = {
	...
	.phy_reset = &hmp_phy_reset,
};

static struct platform_device hmp_phy_device = {
	.name		= "stmmacphy",
	.id		= 0,
	.num_resources	= 1,
...
static struct platform_device *hmp_devices[] __initdata = {
	&smc91x_device,
	&physmap_flash,
	&hmp_phy_device,
};
...
static int __init device_init(void)
{
	...
	phy_reset_pin = stpio_request_set_pin(5, 3, "ste100p_reset",
					      STPIO_OUT, 1);

	stx7100_configure_ethernet(0, 0, 0);

	return platform_add_devices(hmp_devices,
				    ARRAY_SIZE(hmp_devices));
}
