...
static void __iomem *hmp_ioport_map(unsigned long port, unsigned int size)
{
...
static void __init hmp_init_irq(void)
{
...
void __init hmp_setup(char**);

static struct sh_machine_vector mv_hmp __initmv = {
	.mv_name		= "STb7100 Reference board",
	.mv_setup		= hmp_setup,
	.mv_nr_irqs		= NR_IRQS,
	.mv_init_irq		= hmp_init_irq,
	.mv_ioport_map		= hmp_ioport_map,
};
