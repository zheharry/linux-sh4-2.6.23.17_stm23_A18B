/*
 * arch/sh/boards/st/cb103/setup.c
 *
...
static struct plat_ssc_data cb103_ssc_private_info = {
...
static struct mtd_partition cb103_mtd_parts_table[3] = {
	{
		.name = "Boot firmware",
		.size = 0x00040000,
		.offset = 0x00000000,
...
static struct physmap_flash_data cb103_physmap_flash_data = {
	.width		= 2,
	.nr_parts	= ARRAY_SIZE(cb103_mtd_parts_table),
	.parts		= cb103_mtd_parts_table
};

static struct platform_device cb103_physmap_flash = {
	.name		= "physmap-flash",
	.id		= -1,
	.num_resources	= 1,
	...
	.dev		= {
		.platform_data	= &cb103_physmap_flash_data,
	},
};

static int cb103_phy_reset(void *bus)
{
...
static struct plat_stmmacphy_data cb103_phy_private_data = {
	/* MAC0: SMSC LAN8700 */
	.bus_id = 0,
	.phy_addr = -1,
	.phy_mask = 0,
	.interface = PHY_INTERFACE_MODE_MII,
	.phy_reset = cb103_phy_reset,
};

static struct platform_device cb103_phy_device = {
	.name		= "stmmacphy",
	.id		= 0,
	.num_resources	= 1,
	.resource	= (struct resource[]) {
	...
	.dev = {
		.platform_data = &cb103_phy_private_data,
	}
};
...
static struct platform_device cb103_snd_spdif_analog_input = {
	.name = "snd_conv_dummy",
	.id = 0,
...
static struct platform_device cb103_snd_hdmi_input = {
	.name = "snd_conv_dummy",
	.id = 1,
	.dev.platform_data = &(struct snd_stm_conv_dummy_info) {
		.group = "HDMI Input",
...
static struct platform_device *cb103_devices[] __initdata = {
	&cb103_physmap_flash,
	&cb103_phy_device,
#ifdef CONFIG_SND
	&cb103_snd_spdif_analog_input,
	&cb103_snd_hdmi_input,
#endif
};
...
static int __init device_init(void)
{
	...
	stx7200_configure_ssc(&cb103_ssc_private_info);
...
static void __iomem *cb103_ioport_map(unsigned long port, unsigned int size)
{
...
static void __init cb103_init_irq(void)
{
}

struct sh_machine_vector mv_cb103 __initmv = {
	.mv_name		= "cb103",
	.mv_setup		= cb103_setup,
	.mv_nr_irqs		= NR_IRQS,
	.mv_init_irq		= cb103_init_irq,
	.mv_ioport_map		= cb103_ioport_map,
};
